  ...
  return (
    <div>
        ...
        <div className='w-full flex flex-row max-[528px]:flex-col items-center justify-center gap-3'>
            <Link href={"Contact"} className='btn min-w-[200px] bg-linear-to-l  from-[#8f31fc] to-[#4b73ff] border-0 hover:scale-105 ' >View More In GitHup</Link>
            <Link href={"https://github.com/AyaFarh"} className='btn min-w-[200px] border-newGray hover:bg-[#0f1c2e] hover:text-white hover:border-[#295282]' >Let’s collaborate</Link>
        </div>
        </div>
    </div>
  )
